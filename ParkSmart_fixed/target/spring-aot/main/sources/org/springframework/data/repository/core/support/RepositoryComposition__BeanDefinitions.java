...
public class RepositoryComposition__BeanDefinitions {
  ...
  public static class RepositoryFragments {
    /**
     * Get the bean instance supplier for 'jpa.BookingsRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.WalletTransactionsRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.ParkingSpacesRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.PromoCodeRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.ContactRequestsRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.ParkingSlotsRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.ReviewsRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.SlotHoldRepository.fragments#0'.
     */
