...
/**
 * Bean definitions for {@link ReviewsRepository}.
 */
@Generated
public class ReviewsRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'reviewsRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getReviewsRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'reviewsRepository'.
   */
  public static BeanDefinition getReviewsRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, ReviewsRepository.class, Reviews.class, Integer.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.cts.mfrp.parksmart.repository.ReviewsRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.ReviewsRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.cts.mfrp.parksmart.repository.ReviewsRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getReviewsRepositoryInstanceSupplier();
