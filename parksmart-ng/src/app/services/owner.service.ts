...
export class OwnerService {
  ...
  getApprovalRequests(): Observable<any[]> {
    return this.http.post<any[]>(this.BASE + '/approvals/my', {}, { withCredentials: true });
  }
  generateSlots(spaceId: number, levels: number, slotsPerLevel: number): Observable<string> {
    return this.http.post(this.BASE + '/slots/generate', { spaceId, levels, slotsPerLevel }, { withCredentials: true, responseType: 'text' });
  }
}
